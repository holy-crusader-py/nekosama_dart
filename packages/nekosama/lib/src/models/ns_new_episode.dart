...
class NSNewEpisode extends NSEpisode {
  ...
  @override
  String toString() =>
      "NSDatedEpisode(animeId: $animeId, animeUrl: $animeUrl, episodeNumber: $episodeNumber, thumbnail: $thumbnail, url: $url, duration: $duration, addedAt: $addedAt, episodeTitle: $episodeTitle)";
