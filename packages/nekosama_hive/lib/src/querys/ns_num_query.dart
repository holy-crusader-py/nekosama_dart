abstract class NSnumQuery<T extends num> {
  ...
  NSnumQuery.equals(T number) : operation = ((T other) => other == number);
  ...
  NSnumQuery.above(T floor) : operation = ((T other) => floor <= other);

  NSnumQuery.under(T ceiling) : operation = ((T other) => ceiling >= other);
}
